...
# <span style="color:black; font-family:Comic Sans MS;font-size: 20px;"> AI for Neuropathology </span>
...
## <span style="color:teal; font-family:Comic Sans MS;font-size: 16px;"> Attention-based weakly-supervised AI for understanding Chronic Traumatic Encephalopathy (CTE)</span>
...
## <span style="color:teal; font-family:Comic Sans MS;font-size: 160px;">  A vision foundation model for neuropathology for advancing AI-driven neuropathological image analysis</span>
...
# <span style="color:black; font-family:Comic Sans MS;font-size: 20px;"> AI Analysis of Multi-modal Optical Imaging of Human Brain Tissue </span>
## <span style="color:teal; font-family:Comic Sans MS;font-size: 16px;"> Self-supervised registration of Polarization-Sensitive Optical Coherence Tomography (PS-OCT) and quantitative Birefringence Microscopy (qBRM) images</span>
...
# <span style="color:black; font-family:Comic Sans MS;font-size: 20px;">Multimodal AI for breast cancer diagnosis</span>
...
# <span style="color:black; font-family:Comic Sans MS;font-size: 20px;">AI for Colorectal Cancer Diagnosis</span>
...
## <span style="color:teal; font-family:Comic Sans MS;font-size: 16px;">AdaBoost-based multiwavelength Spatial Frequency Domain Imaging (SFDI) for human colorectal tissue assessment</span>
...
# <span style="color:black; font-family:Comic Sans MS;font-size: 20px;">AI-Based Image Reconstruction and Quality Enhancement</span>
